        ...
        for category in categories:
            for region in regions:
                ...
                if month in [11, 12]:  # Holiday season
                    ...
                    seasonal_factor = 1.2 if category in ['Clothing', 'Food & Beverage'] else 1.0
                else:
                    seasonal_factor = 1.0
                ...
                sales = int(base_sales * seasonal_factor * category_factor * region_factor)
...
def generate_customer_feedback(n_samples=500):
    ...
    # Feedback types
    feedback_types = ['Product Quality', 'Customer Service', 'Price', 'Delivery', 'Website Experience']
