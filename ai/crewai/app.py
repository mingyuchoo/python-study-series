...
def create_report_tasks(report_topic, data_sources=None):
    ...
    if data_sources is None:
        data_sources = ["Sample quarterly sales data", "Market trend analysis", "Customer feedback summary"]
...
def generate_presentation(report_topic, crew_results):
    ...
    try:
        ...
        content_placeholder.text = content.split("Executive Summary")[1].split("Introduction")[0].strip()
        ...
        findings_text = content.split("Key Findings")[1].split("Strategic Recommendations")[0].strip()
        ...
        recommendations_text = content.split("Strategic Recommendations")[1].split("Conclusion")[0].strip()
