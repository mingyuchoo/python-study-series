...
def create_developer_tasks(
    ...
    return [
        Task(
            description=f"""Customize and extend the Rust web application template based on the architecture design:
            
            Project Name: {project_name}
            Architecture Design: {design_result}
            
            The project has been initialized with a Rust web application template in the project directory.
            ...
            """,
            agent=agent,
            expected_output="A customized implementation of the Rust web application with documentation",
