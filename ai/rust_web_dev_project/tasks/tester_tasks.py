...
def create_tester_tasks(
    ...
    return [
        Task(
            description=f"""Test the Rust web application implementation:
            
            Project Name: {project_name}
            Implementation Report: {implementation_result}
            
            Your task is to:
            1. Design a comprehensive testing strategy for the Rust application
            ...
            Leverage Rust's testing frameworks (HUnit, HSpec, QuickCheck) to ensure the application
