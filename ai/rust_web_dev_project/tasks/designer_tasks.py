...
def create_designer_tasks(
    ...
    return [
        Task(
            description=f"""Design the architecture for the Rust web application based on the requirements analysis:
            ...
            2. Define the module structure following Rust best practices
            ...
            7. Identify design patterns appropriate for this Rust application
            8. Consider error handling and type safety mechanisms
            
            Create a comprehensive architecture document that leverages Rust's strengths in type safety, 
            immutability, and functional programming paradigms.
            
            Save your design to: {architecture_file}
            """,
            agent=agent,
            expected_output="A detailed architecture design document for a Rust web application",
