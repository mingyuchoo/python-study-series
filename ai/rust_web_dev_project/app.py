...
st.set_page_config(
    page_title="Rust Web Development Team",
    page_icon="🧩",
    layout="wide",
...
# Application title
st.title("🧩 Rust Web Development Multi-Agent System")
st.markdown(
    """This application uses CrewAI to implement a multi-agent collaboration system 
            focused on developing Rust web applications. Multiple agents with specialized roles 
...
if st.session_state.current_step == "input":
    ...
    with st.form("project_form"):
        ...
        st.session_state.project_description = st.text_area(
            ...
            height=150,
            help="Describe the Rust web application you want to build.",
        )
